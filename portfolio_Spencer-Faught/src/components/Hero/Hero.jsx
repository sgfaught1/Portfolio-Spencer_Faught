    ...
    return (
        <section className={styles.container}>
            <div className = {styles.content}>
                ...
                <p className={styles.description}>I'm a frontend developer with 2 years of experience with frontend languages, libraries, and frameworks. Reach out if you'd like to learn more!</p>
